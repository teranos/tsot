-- Black jewel — artifact pitch resource. See red-jewel for the cycle
-- design rationale.
return {
  id = "black-jewel",
  name = "Black Jewel",
  ...
  cost = {},
  abilities = {
    "when this card is attached as a cost to a black card, that creature gets +1/+1 and gains: T: draw a card, discard a card.",
  },
