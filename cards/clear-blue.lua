...
-- on resolution it tutors blue-jewel from deck to hand.
return {
  id = "clear-blue",
  name = "Clear Blue",
  colors = {"blue"},
  ...
  abilities = {
    "when you play this card, search your deck for a blue-jewel OR a blue-symbol card and move it to your hand. self-exile per P.5 — clear blue goes to EXILE on resolution, not GRAVEYARD.",
