...
//!
//! The Makefile passes `RAVE_BUILD_COMMIT` and `RAVE_BUILD_TIME`
...
pub const COMMIT: &str = match option_env!("RAVE_BUILD_COMMIT") {
    Some(c) => c,
    None => "unknown",
};

pub const BUILT_AT: &str = match option_env!("RAVE_BUILD_TIME") {
    Some(t) => t,
    None => "unknown",
};
