...
return {
  ...
  abilities = {
    "when you play this card, search your deck for a white-jewel OR a white-symbol card and move it to your hand. self-exile per P.5 — clear white goes to EXILE on resolution, not GRAVEYARD.",
