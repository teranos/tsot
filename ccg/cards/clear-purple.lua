...
return {
  ...
  abilities = {
    "when you play this card, search your deck for a purple-jewel OR a purple-symbol card and move it to your hand. self-exile per P.5 — clear purple goes to EXILE on resolution, not GRAVEYARD.",
